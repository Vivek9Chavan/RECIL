...
test_image = '/mnt/Dichtung2/messy_47.jpg'
...
checkpoint = '/mnt/GrIL/der_net_InVar100_lite224_messy_12.pth'
...
net = model._modules['convnets']._modules['1']  # resnet18(pretrained=True)
...
for i in range(10):
    ...
    cv2.imwrite('/mnt/1TBNVME/Green_Incremental_Learning/checkpoints/GrIL/DER_CAM/' + str(i) + '.jpg', result)
