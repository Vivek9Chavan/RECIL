...
test_image = '/mnt/1TBNVME/ind_100_val/Dichtung6schwarz/white_39.jpg'

model = torch.load('//mnt/1TBNVME/Green_Incremental_Learning/checkpoints/Dataset_Sampling/pod_net_Invar_lite224_12.pth')

print(model)

'/mnt/1TBNVME/Green_Incremental_Learning/checkpoints/Dataset_Sampling/Finetune_Invar_lite224_5.pth'
#('/mnt/1TBNVME/Green_Incremental_Learning/checkpoints/Dataset_Sampling/pod_net_Invar_lite224_0.pth')
...
net = model._modules['convnet']  # resnet18(pretrained=True)
...
classes = os.listdir('/mnt/1TBNVME/InVar_100_lite/train_resized_224/')
#print(classes)
...
heatmap_sum = np.zeros((2976, 2976, 3), dtype=np.uint8)
...
for i in range(940):
    ...
    if i%10==0:
        ...
        cv2.imwrite('/mnt/1TBNVME/Green_Incremental_Learning/checkpoints/Dataset_Sampling/cam_podnet0/' + str(i) + '.jpg', result)
