...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser('Extract embeddings from the pretrained DeiT model')
    parser.add_argument('--original_images_path', type=str, default='/mnt/logicNAS/DataSets/dimo_small/dimo_small/sim_jaigo_sorted/', help='Path to the image folder')
    parser.add_argument('--feats_path', type=str, default='/mnt/logicNAS/DataSets/dimo_small/dimo_small/sim_jaigo_sorted_feats/', help='Path to save the embeddings')

    image_path = '/mnt/logicNAS/DataSets/dimo_small/dimo_small/sim_jaigo_sorted/'

    save_path = '/mnt/logicNAS/DataSets/dimo_small/dimo_small/sim_jaigo_sorted_feats/'
