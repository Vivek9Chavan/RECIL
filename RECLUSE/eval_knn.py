...
def extract_feature_pipeline(args):
    ...
    print('Forget all that, I be loading DINIO V2! BOOM!')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--nb_knn', default=[3, 6, 10, 20, 50, 100], nargs='+', type=int,
    ...
    parser.add_argument('--data_path', default='/mnt/1TBNVME/vivek/EIBA_Scoring/1_6/', type=str)
